...
<head>
	...
	<title>
		PetShopWeb: <?php echo $this->fetch('title'); ?>
	</title>
	<?php
			...
			<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
			    <div class="navbar-header">
			      <?= $this->Html->link("PetShopWeb", array('controller' => 'pages', 'action' => 'index'), array('class'=>'navbar-brand')); ?>
			    </div>
			    <ul class="nav navbar-nav">
			    
					<li><?= $this->Html->link("Área Geral",	array('controller' => 'produtos', 'action' => 'index')); ?></li>

	...
	<div class="container well">		
		...
		<div class="col-sm-8 col-sm-offset-2" id="conteudo">
			...
			<?php 
				...
				$sql = "SELECT nome, data, preco FROM procedimentos JOIN exames ON procedimentos.id = exames.procedimento_id ORDER BY data ASC";
			...
			<table class="table table-striped table-bordered">
				<tr>
					<th class="text-center"><a href="lista_exame_order_proc.php">Procedimento <i class="fa fa-sort fa-1x" aria-hidden="true"></i></a></th>
					<th class="text-center"><a href="">Data <i class="fa fa-sort fa-1x" aria-hidden="true"></i></a></th>

			...
			<div class="row">
				<div class="col-sm-8">
					<div class="form-group">
						<form action="model_alterar_admin1.php" id="alterarAdmin1" method="post">
							<div class="form-group">
								<label for="nome">Nome:</label>
								<input type="text" id="nome" name="nome" class="form-control" value="<?php echo $linha['nome'] ?>" minlength="0">
							</div>
